...
<script src="{{ url('assets/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js') }}" type="text/javascript"> --}}
{{-- </script> --}}
...
<script src="{{ asset('/assets/global/plugins/jquery-validation/js/additional-methods.js') }}" type="text/javascript">
</script>
{{-- toastr --}}
{{-- summernote editor --}}
...
type="text/javascript"></script>
{{-- dropzone script --}}
<script src="{{ asset('/assets/global/plugins/dropzone/dropzone.min.js') }}"></script>
{{-- sweetalert js --}}
<script src="{{ asset('/assets/global/plugins/bootstrap-sweetalert/sweetalert.min.js') }}"></script>
{{-- croppie --}}
<script src="{{ asset('/assets/global/plugins/croppie/croppie.min.js') }}"></script>
{{-- select 2 --}}
